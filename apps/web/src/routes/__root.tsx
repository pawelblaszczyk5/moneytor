...
import { IconSpritesheetContext } from "@trinse/design-system/components/icon";
import iconsSpritesheet from "@trinse/design-system/icons-spritesheet.svg";
	...
	return (
		<IconSpritesheetContext value={iconsSpritesheet}>
			<html lang="en-US">
				<head>
					<meta charSet="utf-8" />
					<link href="/trinse.svg" rel="icon" type="image/svg+xml" />
