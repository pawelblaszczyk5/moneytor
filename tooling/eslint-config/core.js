...
export default tseslint.config(
	{ name: "settings", linterOptions: { reportUnusedDisableDirectives: "error" } },
	{ name: "eslint config file ignore", ignores: ["eslint.config.js"] },
	gitignore(),
	...
	{ name: "canonical", plugins: { canonical }, rules: { "canonical/filename-no-index": "error" } },
